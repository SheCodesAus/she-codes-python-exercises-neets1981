...
# Write a program that takes two numbers from the user,and outputs the equation 
...
# Writ e a program that takes a distance in kilometers from the user,and output the distance in meters
# and centimeters.
